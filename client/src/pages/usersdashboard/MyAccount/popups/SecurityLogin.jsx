...
import SetupTFAModal from './SetupTFAModal';
import VerifyTFACodeModal from './VerifyTFACodeModal';
import TFASuccessModal from './TFASuccessModal';
    ...
    return (
        <UserLayout>
            <style>{`
                ...
                .security-login-root.root-inner {
                    padding-top: 8px;
                    padding-bottom: 80px;
                    width: 100%;
                    min-height: 100vh;
            ...
            `}</style>
            <div className="security-login-root root-inner">
                ...
                <div className="account-tabs">
                    ...
                    <Link to={`/usersdashboard/account/security`} className="tab-link">
                        <p className="tab-text" style={{ color: theme.accent }}>{t('securityLogin')}</p>
                ...
                <div className="mobile-tab-trigger" onClick={() => setTabsOpen(!tabsOpen)}>
                    ...
                    <div className={`mobile-tab-dropdown${tabsOpen ? ' open' : ''}`}>
                        ...
                        <Link to={`/usersdashboard/account/security`} className="active-tab">{t('securityLogin')}</Link>
