            ...
            <div className="personal-info-root root-inner">
                ...
                <div className="account-tabs">
                    <Link to={`/usersdashboard/account/profile`} className="tab-link">
                        <p className="tab-text" style={{ color: theme.accent }}>{t('personalInfo')}</p>
                    ...
                    <Link to={`/usersdashboard/account/preferences`} className="tab-link">
                        <p className="tab-text" style={{ color: theme.neutralGrey }}>{t('preferences')}</p>
                        <div className="tab-indicator" style={{ backgroundColor: theme.accent, opacity: 0 }} />
                    </Link>
                </div>
                ...
                <div className="mobile-tab-trigger" onClick={() => setTabsOpen(!tabsOpen)}>
                    ...
                    <div className={`mobile-tab-dropdown${tabsOpen ? ' open' : ''}`}>
                        <Link to={`/usersdashboard/account/profile`} className="active-tab">{t('personalInfo')}</Link>
                        <Link to={`/usersdashboard/account/security`}>{t('securityLogin')}</Link>
                        <Link to={`/usersdashboard/account/preferences`}>{t('preferences')}</Link>
                    </div>
                </div>
                            ...
                            <div className="country-row form-row">
                                <div className="field-group">
                                    ...
                                    <div className="dropdown-container">
                                        ...
                                        >
                                            <p className="input-text">{displayCountry}</p>
                ...
                <div className="connected-accounts-section account-section">
                    ...
                    <div className="accounts-list">
                        ...
                        <div className="account-card">
                            <div className="account-header">
                                <div className="account-icon-box">
                                    <svg viewBox="0 0 24 24" fill="none" className="account-logo">
                                        <path d="M18.942 4.069c-1.285-.592-2.658-1.03-4.091-1.278-.178.318-.383.74-.52 1.066-1.547-.231-3.085-.231-4.664 0-.138-.326-.343-.748-.521-1.066-1.433.248-2.806.686-4.092 1.278-2.583 3.86-3.287 7.625-2.937 11.339 1.716 1.264 3.376 2.037 4.996 2.539.404-.551.764-1.14 1.07-1.758-.588-.221-1.148-.488-1.68-.804.14-.103.277-.212.41-.324 3.257 1.498 6.786 1.498 10 0 .133.112.27.221.41.324-.532.316-1.092.583-1.681.804.305.618.667 1.207 1.07 1.758 1.62-.502 3.28-1.275 4.996-2.539.421-4.32-.71-8.046-2.938-11.339zM8.02 14.12c-.958 0-1.748-.879-1.748-1.954s.772-1.954 1.748-1.954c.983 0 1.765.879 1.757 1.954.008 1.075-.774 1.954-1.757 1.954zm7.96 0c-.958 0-1.748-.879-1.748-1.954s.772-1.954 1.748-1.954c.983 0 1.765.879 1.757 1.954.008 1.075-.774 1.954-1.757 1.954z" fill="#5865F2" />
                                    </svg>
                                </div>
                                <div className="account-name-group">
                                    <p className="account-name">{t('discord')}</p>
                                    <p className="account-val">{t('notConnected')}</p>
                                </div>
                            </div>
                            <button className="account-card-btn" style={{ backgroundColor: theme.accent, color: 'white' }}>
                                {t('connect')}
                            </button>
                        </div>
                    </div>
