...
const TFASuccessModal = ({ isOpen, onClose }) => {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(11, 11, 15, 0.9)', backdropFilter: 'blur(12px)', padding: '0.5vh' }} onClick={onClose}>
            <div
                style={{
            ...
            >
                {/* Close Button */}
                <div style={{ display: 'flex', justifyContent: 'flex-end', width: '100%', marginBottom: '2vh' }}>
                    <div
                ...
                {/* Text Content */}
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', width: '100%', gap: '1vh', marginBottom: '4vh', padding: '0 2vw' }}>
                    <h1 style={{ color: 'white', fontWeight: 800, whiteSpace: 'nowrap', fontSize: '2.5vh', margin: 0 }}>
                        {t('2fa_enabled_successfully')}
                    </h1>
                    <p style={{ color: '#a5a5b2', fontSize: '1.8vh', lineHeight: '1.6', margin: 0 }}>
                        {t('you_will_need_code_to_login')}
                    </p>
                </div>
