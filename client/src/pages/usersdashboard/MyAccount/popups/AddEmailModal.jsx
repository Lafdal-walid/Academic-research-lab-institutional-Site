...
const AddEmailModal = ({ isOpen, onClose, onSendCode, email, setEmail }) => {
        ...
        <div onClick={handleBackdropClick} className="add-email-backdrop">
            ...
            <div className="modal-container">
                ...
                <div className="text-content">
                    <h1 className="add-email-title">{t('add_email_title')}</h1>
                ...
                <div className="input-section">
                    <label className="input-label">{t('enter_email_label')}</label>
