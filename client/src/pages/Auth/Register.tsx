...
const Register = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        email: '',
        password: '',
        agree: true // Set default to true for better UX in this demo
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.username) { newErrors.username = 'Username is required'; hasError = true; }
        ...
        console.log('Register attempt (Step 1):', formData);

        setTimeout(() => {
            setIsSubmitting(false);
            setStep(2); // Proceed to Phone Verification
        }, 1000);
    };

    const handleStep2Submit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log('Verification code requested for:', selectedCountry.code + phoneNumber);
        setIsSubmitting(true);
        setTimeout(() => {
            setIsSubmitting(false);
            setStep(3); // Proceed to OTP entry
        }, 1000);
    };
    ...
    const handleVerifyOtp = (e: React.FormEvent) => {
        e.preventDefault();
        setIsSubmitting(true);
        console.log('Verifying Phone OTP:', otp.join(''));
        setTimeout(() => {
            setIsSubmitting(false);
            setOtp(['', '', '', '']); // Reset for next step
    ...
    const handleVerifyEmailOtp = (e: React.FormEvent) => {
        e.preventDefault();
        setIsSubmitting(true);
        console.log('Verifying Email OTP:', otp.join(''));
        setTimeout(() => {
            setIsSubmitting(false);
            navigate('/login');
        }, 1500);
                        ...
                        {step === 1 ? (
                            <div className="animate-fade-in flex flex-col gap-[28px]">
                                ...
                                <div className="content-stretch flex flex-col gap-[6px] items-center leading-[normal] not-italic relative shrink-0 text-center w-full">
                                    ...
                                    <p className="font-regular relative shrink-0 text-[#a5a5b2] text-[13.5px] w-full font-poppins">Create your account to stay updated and manage your experience in one place.</p>
                                </div>
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col gap-[18px]">
                                    ...
                                    <div className="content-stretch flex items-center justify-center py-2 relative shrink-0 w-full">
                                        <p className="flex-[1_0_0] font-regular leading-[normal] not-italic relative text-[12.5px] text-center text-white">
                                            ...
                                            <Link to="/login" className="decoration-solid font-poppins font-medium text-accent underline">Log in </Link>
                                        </p>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div className="animate-fade-in flex flex-col gap-[28px]">
                                ...
                                <div onClick={() => setStep(1)} className="content-stretch flex flex-col items-start relative shrink-0 w-full cursor-pointer group">
                                    <div className="content-stretch flex gap-1.5 items-center relative shrink-0 w-full hover:brightness-125 transition-all">
                                        <div className="flex items-center justify-center relative shrink-0 size-[24px]">
                                            <div className="flex-none rotate-90 transition-transform group-hover:-translate-x-1">
                                                <AngleSmallDown />
                                ...
                                <form onSubmit={handleStep2Submit} className="flex flex-col gap-[24px]">
                                    ...
                                    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full z-20">
                                        <p className="font-regular leading-[normal] not-italic relative shrink-0 text-[#80808a] text-[12.5px] w-full">Country</p>
                                    ...
                                    {/* Phone Field */}
                                    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
                                        <p className="font-regular leading-[normal] not-italic relative shrink-0 text-[#80808a] text-[12.5px] w-full">Phone Number</p>
                            ...
                            <div className="animate-fade-in flex flex-col gap-[32px] w-full">
                                {/* Back Button (Go back to step 2) */}
                                <div onClick={() => setStep(2)} className="content-stretch flex items-center gap-[12px] relative shrink-0 w-full cursor-pointer group">
                                    <div className="flex items-center justify-center relative shrink-0 size-[24px]">
                                        <div className="flex-none rotate-90 transition-transform group-hover:-translate-x-1">
                                            <AngleSmallDown />
                                        </div>
                                ...
                                {/* Step 3 Text */}
                                <div className="content-stretch flex flex-col gap-[6px] items-center leading-[normal] not-italic relative shrink-0 text-center w-full">
                                    <h1 className="font-gilroy font-extrabold relative shrink-0 text-[20px] text-white w-full tracking-tight">Create your account</h1>
                                    <p className="font-poppins font-regular relative shrink-0 text-[#a5a5b2] text-[14px] w-full px-4">
                                        We've sent a 4-digit code to <span className="text-white font-medium">{selectedCountry.code} {phoneNumber}</span>
                                    </p>
                                </div>

                                <form onSubmit={handleVerifyOtp} className="flex flex-col gap-[32px]">
                                    {/* OTP Inputs - Figma Style (Tall boxes, large digits) */}
                                        ...
                                        {otp.map((digit, index) => (
                                            <div key={index} className="bg-white/[0.01] flex-[1_0_0] h-full relative rounded-[12px] transition-all focus-within:bg-accent/5">
                                                ...
                                                <input
                                                    ...
                                                    className="bg-transparent border-none outline-none size-full text-center text-[72px] font-poppins font-bold text-white transition-all p-0 selection:bg-accent/30 caret-transparent"
                                                    autoFocus={index === 0}
                                                />
                                            </div>
                                        ))}
                                    ...
                                    <div className="flex flex-col gap-[16px] items-center pb-[12px]">
                                        <button
                                            ...
                                            className="bg-accent hover:bg-accent/90 text-white rounded-[12px] py-[14px] shrink-0 w-full text-[14px] font-poppins font-medium transition-all active:scale-[0.98] disabled:opacity-50"
                                        >
                                            {isSubmitting ? "Verifying..." : "Verify Phone"}
                                        </button>
                                        <p className="font-poppins font-regular text-[14px] whitespace-nowrap">
                            ...
                            <div className="animate-fade-in flex flex-col gap-[32px] w-full">
                                {/* Back Button (Go back to step 3) */}
                                <div onClick={() => setStep(3)} className="content-stretch flex items-center gap-[12px] relative shrink-0 w-full cursor-pointer group">
                                    <div className="flex items-center justify-center relative shrink-0 size-[24px]">
                                        <div className="flex-none rotate-90 transition-transform group-hover:-translate-x-1">
                                            <AngleSmallDown />
                                        </div>
                                ...
                                {/* Step 4 Text */}
                                <div className="content-stretch flex flex-col gap-[6px] items-center leading-[normal] not-italic relative shrink-0 text-center w-full">
                                    <h1 className="font-gilroy font-extrabold relative shrink-0 text-[20px] text-white w-full tracking-tight">Check your email</h1>
                                    <p className="font-poppins font-regular relative shrink-0 text-[#a5a5b2] text-[14px] w-full px-4 whitespace-nowrap">
                                        We've sent a 4-digit verification code to <span className="text-accent font-medium tracking-tight">{formData.email || 'oualidlafdal50@gmail.com'}</span>
                                    </p>
                                </div>

                                <form onSubmit={handleVerifyEmailOtp} className="flex flex-col gap-[32px]">
                                    {/* OTP Inputs - Figma Style */}
                                    <div className="flex justify-center gap-[20px] h-[163px]">
                                        {otp.map((digit, index) => (
                                            <div key={index} className="bg-white/[0.01] flex-[1_0_0] h-full relative rounded-[12px] transition-all focus-within:bg-accent/5">
                                                <div className={`absolute border ${digit ? 'border-accent' : 'border-[#2a2a30]'} border-solid inset-0 pointer-events-none rounded-[12px] transition-colors`} />
