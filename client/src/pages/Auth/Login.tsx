    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#0B0A0C] relative overflow-hidden font-poppins text-white">
            ...
            <div className={`w-full ${showSuccess ? 'max-w-[400px]' : 'max-w-[543px]'} z-10 relative flex flex-col items-center justify-center transition-all duration-500`}>
                ...
                {/* Form Card */}
                <div className={`bg-[#151519] border border-white/5 px-8 pt-5 ${showSuccess ? 'pb-6' : 'pb-10'} rounded-[16px] shadow-2xl backdrop-blur-md w-full ${showSuccess ? 'min-h-[300px]' : 'min-h-[400px]'} flex flex-col justify-center transition-all duration-500 relative overflow-visible scale-in`}>
                    {!showSuccess ? (
                        ...
                        <div className="flex flex-col items-center justify-center gap-[40px] animate-scale-in pt-[40px] pb-[20px]">
