    ...
    <div className="min-h-screen bg-[#050505] text-white py-20 px-4 font-sans selection:bg-blue-500/30">
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        {faqData.map((item) => (
          <div
            key={item.id}
            className={`group border rounded-xl transition-all duration-300 ${activeId === item.id ? 'border-blue-600 bg-[#0d0d0d]' : 'border-white/10 bg-[#080808] hover:border-white/20'
              }`}
          >
            <button
