  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto relative z-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-14 lg:gap-[0.9em] mb-[45px] items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-[18px]">
            <div className="flex items-center gap-2">
              <Link to="/">
                <img src="/Saad Dahlab white.png" alt="Saad Dahlab Research Institute" className="h-[42px] md:h-[68px] w-auto object-contain" />
              </Link>
            </div>
            <p className="text-white text-[13px] max-w-[288px] leading-relaxed font-normal">
              Advanced scientific research platform <br /> designed to accelerate discovery without <br /> complexity.
            </p>
          ...
          <div className="lg:col-span-3 lg:ml-[4.2vw] lg:-mt-[2vh]">
            <div className="relative mb-[28px]">
              <svg className='absolute -top-[21px] -left-10' width="7" height="7" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul className="flex flex-col gap-[12px] text-[13px] font-normal text-white">
              <li><Link to="/projects" className="hover:text-[#3457DC] transition-colors">Projects</Link></li>
              <li><Link to="/publications" className="hover:text-[#3457DC] transition-colors">Publications</Link></li>
              <li><Link to="/teams-researches" className="hover:text-[#3457DC] transition-colors">Teams Researches</Link></li>
              <li><Link to="/about-us" className="hover:text-[#3457DC] transition-colors">About Us</Link></li>
            </ul>
          </div>

          {/* Right Column: Support */}
          <div className="lg:col-span-3 lg:ml-[6vw] lg:-mt-[2vh]">
            <div className="relative mb-[28px]">
              <svg className='absolute -top-[21px] -left-10' width="7" height="7" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 0V8H0L8 0Z" fill="white" />
              </svg>
            ...
            <ul className="flex flex-col gap-[12px] text-[13px] font-normal text-white">
              <li><Link to="/support" className="hover:text-[#3457DC] transition-colors">Contact us</Link></li>
              <li><Link to="/support" className="hover:text-[#3457DC] transition-colors">FAQ</Link></li>
              <li><Link to="/support" className="hover:text-[#3457DC] transition-colors">Suggestions</Link></li>
              <li>
                <a href="mailto:oualidlafdaI50@gmail.com" className="hover:text-[#3457DC] transition-colors flex items-center gap-[4px] text-[13px]">
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center pt-[36px] border-t border-white/5 gap-[21px] relative">
          {/* Decorator Dot */}
          <div className="hidden lg:block absolute right-0 top-0 -translate-y-[calc(100%+1vh)]">
            <div className="w-[7px] h-[7px] bg-white" />
          </div>

          <div className="text-[13px] md:text-[14px] text-center md:text-start order-1 md:order-1 text-white font-normal">
            © Oualid Lafdal . All rights reserved.
          </div>
          ...
          <div className="flex items-center text-[12px] md:text-[13px] gap-[28px] md:gap-[57px] order-2 md:order-3 font-normal text-white">
            <Link to="/support" className="hover:text-[#3457DC] transition-colors">Privacy policy</Link>
            <Link to="/support" className="hover:text-[#3457DC] transition-colors">Terms & conditions</Link>
          </div>
        </div>
      </div>
    </footer>
